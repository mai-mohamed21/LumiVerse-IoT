...
/// build a dynamic Dashboard to view sensor data in real-time
///
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Real-time monitoring • Last updated 2s ago',
                            style: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                                  font: GoogleFonts.inter(
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                FutureBuilder<List<SensorAveragesRow>>(
                                  future: SensorAveragesTable().queryRows(
                                    queryFn: (q) => q,
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    ...
                                    List<SensorAveragesRow>
                                        textSensorAveragesRowList =
                                        snapshot.data!;

                                    return Text(
                                      valueOrDefault<String>(
                                        textSensorAveragesRowList
                                            .firstOrNull?.avgValue
                                            ?.toString(),
                                        '0',
                                      ),
                                      style: FlutterFlowTheme.of(context)
